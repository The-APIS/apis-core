 ...
 cy.request('POST', `${Cypress.config('baseUrl')}/api/v1/tokens?apiKey=58fc282a-498f-4695-88ac-f694fa98df9d&chain=ethereum&network=rinkeby`,
{
 ...
 "privateKey": "6143bba50362ca9f80d1148a33aafd5789a5d97e8e4501837f8eadad48627e98"
}
 )
  .should((response) => {
   expect(response.body).to.have.property('nonce')
...
it('ERC20 token balance', () => {
 cy.request('GET', `${Cypress.config('baseUrl')}/api/v1/tokens/0x0c623F6164Fca9a5d146917a93497E5946CC7340/balance?tokenAddress=0xB904c75e1B615B93bcb4f089322E0c12464900fc&type=erc20&apiKey=58fc282a-498f-4695-88ac-f694fa98df9d&chain=ethereum&network=rinkeby`
 )
  .should((response) => {
...
it('ERC721 token balance', () => {
 cy.request('GET', `${Cypress.config('baseUrl')}/api/v1/tokens/0x6A3Cd6a4f7288a43921Ff88796cb75D9e36A8b9A/balance?tokenAddress=0xde30ffcf679896f119dec2c0aa330638e1d97526&type=erc721&apiKey=58fc282a-498f-4695-88ac-f694fa98df9d&chain=ethereum&network=rinkeby`
 )
  .should((response) => {
   expect(response.body).to.have.property('balance')
 })
...
it('ERC1155 token balance', () => {
 cy.request('GET', `${Cypress.config('baseUrl')}/api/v1/tokens/0x6A3Cd6a4f7288a43921Ff88796cb75D9e36A8b9A/erc1155/balance?tokenAddress=0x85c95902239797b69beab4e617411fb94981a2a9&type=erc1155&id=1&apiKey=58fc282a-498f-4695-88ac-f694fa98df9d&chain=ethereum&network=rinkeby`
 )
  .should((response) => {
